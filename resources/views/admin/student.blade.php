        ...
        <table class="table" id="studentTable" >
            ...
            @forelse($students as $student)
                <tr class='item{{ $student->id }}'>
                    ...
                    <td>
                        <button class='show-modal btn btn-success btn-sm' data-address='{{ $student->address }}' data-dob="{{ $student->dob }}" data-regno='{{ $student->regno }}' data-id='{{ $student->id }}' data-gender='{{ $student->gender }}' data-proctor='{{ $student->proctor }}' data-email='{{ $student->email }}' data-contact='{{ $student->contact }}' data-semester='{{ $student->semester }}' d{{ asset("storage/images/students/".$student->avatar)}}' data-name='{{ $student->name }}' data-p_contact = '{{ $student->p_contact }}' data-p_email = '{{ ($student->p_email)? $student->p_email: "No email" }}' data-course='{{ $student->course }}'><span class='fa fa-eye'></span></button>
