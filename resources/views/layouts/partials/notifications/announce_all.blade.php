...
<a class="dropdown-item message-container container" onclick="notificationExpander('{{ $notification->data['user']['name'] }}', '{{ $notification->data['announcement']['message']}}');" href="#" data-toggle="modal" data-target="#showMessage">
