            ...
            success: function(data){
                ...
                if(data === "" || data === NaN || data.length === 0){
                    ...
                    for(i=0;i<data.length;i++){
                        result += "<tr class='item" + data[i].id + "'><td>" + data[i].regno + "</td><td>"+ data[i].name + "</td><td>" + data[i].email + "</td><td>" + data[i].courseName +"</td><td><button class='btn btn-sm btn-info show-modal' data-id='" + data[i].id + "' data-name='" + data[i].name + "' data-regno='" + data[i].regno + "' data-course='" + data[i].courseName + "' data-email='" + data[i].email + "' data-contact='" + data[i].contact + "' data-dob='" + data[i].dob + "' data-gender='" + data[i].gender + "' data-proctor='" + data[i].proctorName + "' ><span class=\'fa fa-eye\'></span> Full Details</button></tr>";
                    }
                    result += bottom;
